...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=40, verbose_name='Компания')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_company', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='company', to='atlas.company', verbose_name='Компания')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=40, verbose_name='Название датчика')),
                ('id_sensor', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='event_sensor', to='atlas.object', verbose_name='Датчик')),
            ],
        ),
        migrations.CreateModel(
            name='SensorEvent',
            fields=[
                ...
                ('date_of_service_planned', models.DateTimeField(blank=True, default=datetime.datetime(2022, 6, 16, 13, 40, 13, 792722), verbose_name='Запланировано')),
                ...
                ('id_sensor', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='sensor', to='atlas.object', verbose_name='Датчик')),
            ],
        ),
        migrations.CreateModel(
            name='SensorData',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('info', models.CharField(max_length=100, verbose_name='Информация')),
                ('image', models.ImageField(blank=True, upload_to='', verbose_name='Cхема')),
                ('id_object', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='object', to='atlas.object', verbose_name='Объект')),
            ],
        ),
    ]
