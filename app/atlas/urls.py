...
urlpatterns = [
    ...
    path('sensor/<int:sensor_id>/settings', views.settings_sensor, name='settings_sensor'),
    ...
    path('object/<int:object_id>/settings', views.object_settings, name='object_settings'),
