    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('objects_cmn_groups', django.contrib.postgres.fields.ArrayField(base_field=models.IntegerField(), size=None, verbose_name='Группы доступа Сmn')),
                ('objects_ai_groups', django.contrib.postgres.fields.ArrayField(base_field=models.IntegerField(), size=None, verbose_name='Группы доступа Ai')),
